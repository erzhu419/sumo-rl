...
def main():
    ...
    parser.add_argument('--high_precision', action='store_true', help='Force update_freq=1 for comparison')
    args = parser.parse_args()

    # Build the bridge components using the exact factory call from sac_ensemble
    freq = 1 if args.high_precision else 10
    print(f"Using update_freq={freq} (High Precision: {args.high_precision})")
    ...
    print("Starting Legendary Hard Rule Baseline (ac0be9) Simulation...")
    ...
    print("========================================")
    print("Legendary Hard Rule Baseline Finished!")
