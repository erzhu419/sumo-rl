...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        for eps in range(1):
            sac_trainer.load_model(r'/home/erzhu419/mine_code/sumo-rl/LSTM-RL-legacy/ensemble_version/model/sac_ensemble_SUMO_linear_penalty_Production_Augmented_BangBang_V7_Long/checkpoint_episode_0')
